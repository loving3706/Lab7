...
public class RPSLSpock {
     ...
     * @return returns a user input after ensuring it is a valid pick
     */
    ...
    /**
     * generates the computer's pick
     * @return returns the computer's choice
     */
    ...
    /**
     * Compares the computer's choice to the user's choice and decides the winner
     * @param c_pick the computer's pick
     * @param h_pick the user's pick
     * @return true if the computer wins and false if the computer loses
     */
